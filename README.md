...
|---|---|---:|---:|---:|
| **Opus 4.7 ceiling** ⁰ | Chen-Truong prompt template | **99.22** | $0 (no API) | n/a |
...
⁰ The Opus 4.7 row is a *rubric-attainable ceiling* generated by `Code/src/build_opus_responses.py` (Chen-Truong prompt-engineering applied via Python templating), auto-graded by the same rubric. It is not a billed Anthropic API result. See `REPORT.md` §3.1 footnote for the methodology disclosure.
