...
**Team:** Donglin Liu · Alexander Ge  ·  **Course:** EC/BE 552 — Boston University, Spring 2026  ·  **Repo:** [Otto1221/EC552_Final_Project](https://github.com/Otto1221/EC552_Final_Project)
...
⁺ Mac LoRA reflects the n=34 stride-3 subset (Cell C, post-loop-fix); the full n=100 run averages 91.57. See `REPORT.md` §3.7 for stride-vs-full discussion.
